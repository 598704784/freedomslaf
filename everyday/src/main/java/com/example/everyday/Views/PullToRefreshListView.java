...
public class PullToRefreshListView extends ListView {
	...
	private void initHeaderView() {
		mHeaderView = View
				.inflate(getContext(), R.layout.refresh, null);
		this.addHeaderView(mHeaderView);

		tvTitle = (TextView) mHeaderView.findViewById(R.id.tv_fresh);
		tvTime = (TextView) mHeaderView.findViewById(R.id.tv_date);
		ivArrow = (ImageView) mHeaderView.findViewById(R.id.arr);
		pbProgress = (ProgressBar) mHeaderView.findViewById(R.id.pb_menu);
	...
	public void onRefreshaComplete(boolean success) {
	...
	public void setOnRefreshaListener(OnRefreshListener listener) {
		mListener = listener;
	}
